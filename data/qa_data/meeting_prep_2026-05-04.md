...
1. **Mapping approach** — expand Sheet2 to include the 17 noncanonical labels Ken's been using, OR keep Sheet2 tight and maintain a separate `correction_category_mapping.csv` lookup?
