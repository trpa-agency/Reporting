...
```powershell
& "C:/Program Files/ArcGIS/Pro/bin/Python/envs/arcgispro-py3/python.exe" "C:/Users/mbindl/Documents/GitHub/Reporting/residential_units_etl/main.py" --skip-s01 --skip-s05
```
...
| Builder script | `residential_units_etl/build_genealogy_master.py` |
| ETL application step | `residential_units_etl/steps/s02b_genealogy.py` |
