...
const REPO   = "C:/Users/mbindl/Documents/GitHub/Reporting";
const TMP    = path.join(REPO, "tmp");
const SHOTS  = path.join(TMP, "dashboard_screenshots");
const DATA   = JSON.parse(fs.readFileSync(path.join(TMP, "dashboard_content.json"), "utf-8"));
