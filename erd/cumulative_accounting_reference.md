# TRPA Cumulative Accounting — framework reference

> **This is a plain-markdown copy of the `trpa-cumulative-accounting` skill
> ([.claude/skills/trpa-cumulative-accounting/SKILL.md](../.claude/skills/trpa-cumulative-accounting/SKILL.md)),
> kept in `erd/` so team members who don't use Claude can still read the
> vocabulary reference directly alongside the schema proposal. The two files
> are kept in sync; edit the skill version and re-copy.**
