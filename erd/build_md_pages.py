...
NAV_LABELS = {
    ...
    "proposed_dashboards": "Dashboards",
    "dashboards_to_schema_trace": "Dashboards \u2192 Schema Trace",
    "genealogy_track": "Track A (Genealogy)",
    "allocation_track": "Track B (Allocations)",
    "qa_corrections_track": "Track C (QA Corrections)",
    "xlsx_decomposition": "XLSX Decomposition",
    "raw_data_vs_corral": "raw_data vs Corral",
    "validation_findings": "Validation Findings",
    "cumulative_accounting_reference": "Cumulative Accounting Reference",
...
NAV_ORDER = [
    ...
    "genealogy_track",
    "allocation_track",
    "qa_corrections_track",
    "cumulative_accounting_reference",
    "raw_data_vs_corral",
    "validation_findings",
    "xlsx_decomposition",
    "corral_tables",
